...
$APPLICATION->AddHeadScript('//j-ulrich.github.io/jquery-simulate-ext/jquery.simulate.js');
?>
		...
		<thead>
			<tr class="crm-items-table-header">
				<td class="crm-item-cell crm-item-name">
                    <span class="crm-item-cell-text"><?=htmlspecialcharsbx(GetMessage('CRM_PRODUCT_ROW_COL_TTL_NAME'))?></span>
                    <?//кастом - вівод веса - в lang-файле текст?>
                    /<span class="crm-item-cell-text"><?=htmlspecialcharsbx(GetMessage('CRM_PRODUCT_ROW_COL_TTL_WEIGHT'))?></span>
                </td>
