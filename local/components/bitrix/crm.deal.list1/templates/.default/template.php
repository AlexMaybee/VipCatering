		...
		$resultItem = array(
			...
			'columns' => array(
				...
				'ASSIGNED_BY' => $arDeal['~ASSIGNED_BY_ID'] > 0 ?
					...
					'<script type="text/javascript">BX.tooltip('.$arDeal['~ASSIGNED_BY_ID'].', "balloon_'.$arResult['GRID_ID'].'_'.$arDeal['ID'].'", "");</script>'
					: '',
	...
	array(
		...
		'FOOTER' => array(
			array(
				...
				'service_url' => '/bitrix/components/bitrix/crm.deal.list/list.ajax.php?'.bitrix_sessid_get()
			),
