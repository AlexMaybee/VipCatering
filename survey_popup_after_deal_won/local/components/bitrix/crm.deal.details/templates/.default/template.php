...
/*Menu and personel code*/
?>

    <div style="display: flex;margin-bottom:30px;">

        <div style="display: inline-block; margin-right:10px; max-width:50%;min-width: 180px;">
            <?$APPLICATION->IncludeComponent(
                "uamaster:estimate.element.list",
                "",
                Array(
                    "COMPONENT_TEMPLATE" => ".default",
                    "IBLOCK_ID" => "52",
                    "IBLOCK_TYPE" => "catering",
                    "IBLOCK_ID_ELEMENT" => "53",
                    "quote"=>$arResult['ENTITY_ID']
                )
            );?>
        </div>

        <div style="clear:both;display: inline-block;margin-right:10px; max-width:50%; min-width: 200px;">
            <?########### menu
            $APPLICATION->IncludeComponent(
                "uamaster:estimate.pers.list",
                ".default",
                array(
                    "COMPONENT_TEMPLATE" => ".default",
                    "IBLOCK_ID" => "56",
                    "IBLOCK_TYPE" => "catering",
                    "IBLOCK_ID_ELEMENT" => "56",
                    "quote" => $arResult["ENTITY_ID"]
                ),
                false
            );?>
